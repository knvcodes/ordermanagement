...
import { deliveryFormSchema, type DeliveryFormData } from '../../validations/order';
...
export default function DeliveryForm({ onSubmit }: DeliveryFormProps) {
  ...
  return (
    <form className="delivery-form" onSubmit={handleSubmit(onSubmit)} noValidate>
      ...
      <div className="delivery-form-field">
        ...
        <input
          ...
          {...register('name')}
        />
        {errors.name && <p className="delivery-form-error">{errors.name.message}</p>}
      </div>
      ...
      <div className="delivery-form-field">
        ...
        <textarea
          ...
          {...register('address')}
        />
        {errors.address && <p className="delivery-form-error">{errors.address.message}</p>}
      </div>
      ...
      <div className="delivery-form-field">
        ...
        <input
          ...
          {...register('phone')}
        />
        {errors.phone && <p className="delivery-form-error">{errors.phone.message}</p>}
      </div>
      ...
      <div className="delivery-form-field">
        ...
        <textarea
          ...
          {...register('notes')}
        />
        {errors.notes && <p className="delivery-form-error">{errors.notes.message}</p>}
      </div>
